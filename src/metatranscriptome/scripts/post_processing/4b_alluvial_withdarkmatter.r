...
# alluvialorder14 <- c("Missing", used_category_totals$used_NTorNR) this will mess up plots keep missing last
...
## this will add one more, let's try keeping all instead
#data_alluvialdm <- data_alluvialadm
#sumcountonepercent8 <- sumcountonepercent / 8
#data_alluvialdm <- data_alluvialadm %>% dplyr::filter(count > sumcountonepercent8)
## problem is both of these leave too much text in the plot, reverting to 4
...
#cl14grayfirst <- c("#36454F", "#E41A1C", "#377EB8", "#4DAF4A", "#984EA3", "#FF7F00", "#FFFF33", 
#             "#A65628", "#F781BF", "#999999", "#FF62BC", "#A3A500",
#             "#B3E5FC", "#FFCC80", "#36454F")  # do not use
