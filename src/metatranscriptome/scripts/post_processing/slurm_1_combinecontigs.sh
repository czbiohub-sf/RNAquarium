...
#SBATCH --job-name=step1_RNAquarium_metatranscriptome_NTNRcombining_andplotting
...
Rscript 1_combinecontigs_alluvial_treemap.r
...
Rscript 1_combinecontigs_alluvial_treemap_withtaxid.r
