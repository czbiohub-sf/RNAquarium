...
# Configuration
TSV_FILE="/path/to/RNAquarium_outputs/taxonomy_hits_nonhost_mostrecent.tsv.gz"
NAMES_DMP="/path/to/databases/taxonomizr/aug2025taxonomy/names.dmp"
OUTPUT_FILE="/path/to/RNAquarium_outputs/taxonomy_hits_nonhost_mostrecent_withtaxids.tsv.gz"
